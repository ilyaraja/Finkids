angular
  ...
  .controller(
    ...
    function (
      ...
      (this.dt_data = []),
        (this.dtOptions = DTOptionsBuilder.fromSource("data/dt_data.json")
          .withDisplayLength(10)
          .withOption("scrollY", "200px")
          .withOption("scrollCollapse", !1)
          .withOption("paging", !1)
          .withOption("initComplete", function () {
            $timeout(function () {
              $compile($(".dt-uikit .md-input"))($scope);
  ...
  .controller(
    ...
    function (
      ...
      (this.dtOptions = DTOptionsBuilder.fromSource("data/dt_data.json")
        ...
        .withColumnFilter({
          aoColumns: [
            { type: "text", bRegex: !0, bSmart: !0 },
            { type: "text", bRegex: !0, bSmart: !0 },
            { type: "text", bRegex: !0, bSmart: !0 },
            { type: "number", bRegex: !0, bSmart: !0 },
            { type: "number", bRegex: !0, bSmart: !0 },
            { type: "number", bRegex: !0, bSmart: !0 },
          ],
        })
  ...
  .controller(
    ...
    function (
      ...
      (this.dtOptions = DTOptionsBuilder.fromSource("data/dt_data.json")
        .withDOM(
          "<'dt-uikit-header'<'uk-grid'<'uk-width-medium-2-3'l><'uk-width-medium-1-3'f>>><'uk-overflow-container'tr><'dt-uikit-footer'<'uk-grid'<'uk-width-medium-3-10'i><'uk-width-medium-7-10'p>>>"
        )
        .withPaginationType("full_numbers")
        .withButtons(["colvis"])),
        (this.dtColumnDefs = [
