    ...
    .controller('tourCtrl', [
        ...
        function ($scope,$timeout) {
            ...
            function tourInit() {
                ...
                // initialize instance
                $scope.enjoyhint_instance = new EnjoyHint({});
                ...
                // set script config
                $scope.enjoyhint_instance.set(enjoyhint_script_steps);

                // run Enjoyhint script
                $scope.enjoyhint_instance.run();
            ...
            $scope.$on('$destroy', function() {
                $scope.enjoyhint_instance.trigger('skip');
                $scope.enjoyhint_instance = null;
            });
