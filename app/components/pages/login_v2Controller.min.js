angular.module("altairApp").controller("login_v2Ctrl", [
  "$scope",
  "$rootScope",
  "utils",
  function ($scope, $rootScope, utils) {
    $scope.registerFormActive = !1;
    ...
    ($scope.loginHelp = function ($event) {
      $event.preventDefault(),
        utils.card_show_hide($login_card, void 0, login_help_show, void 0);
    }),
      ($scope.backToLogin = function ($event) {
        $event.preventDefault(),
          ($scope.registerFormActive = !1),
          utils.card_show_hide($login_card, void 0, login_form_show, void 0);
      }),
      ($scope.registerForm = function ($event) {
        $event.preventDefault(),
          ($scope.registerFormActive = !0),
          utils.card_show_hide($login_card, void 0, register_form_show, void 0);
      }),
      ($scope.passwordReset = function ($event) {
        $event.preventDefault(),
          utils.card_show_hide(
            $login_card,
            void 0,
            password_reset_show,
            void 0
